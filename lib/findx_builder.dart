...
class _FindXBuilderState<T extends FindXController> extends State<FindXBuilder<T>> {
  ...
  Widget build(BuildContext context) {
    if(_controller == null){
      ...
      if(widget.put != null){
        ...
        FindXStore.of(context)!.store.put<T>(_controller!,id: _controller!.id);
      }else{
        _controller = FindXStore.of(context)!.store.find<T>(id: widget.idController);
      }
